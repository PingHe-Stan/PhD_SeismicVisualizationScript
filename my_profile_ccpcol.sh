...
# Data for Plotting
datadir=/home/hep/Nepal/RF_GMT/4_CCP_Lat_Dist/Data
...
# The stacking identifier is lat or lon of projection piercing points.(dcvreg,dcvinci)
...
profile_start6=0
profile_start7=0
profile_end1=`awk 'NR==2{print $2}' $proflengthfile`
profile_end2=`awk 'NR==3{print $2}' $proflengthfile`
profile_end3=`awk 'NR==4{print $2}' $proflengthfile`
profile_end4=`awk 'NR==5{print $2}' $proflengthfile`
profile_end5=`awk 'NR==6{print $2}' $proflengthfile`
profile_end6=`awk 'NR==7{print $2}' $proflengthfile`
profile_end7=`awk 'NR==8{print $2}' $proflengthfile`


# The stacking identifier is distance form projected piercing point to starting points.(signoise)
...
# Set wiggle color. The smaller the value, the darker the filled color becomes
pos="firebrick1" 
neg="-steelblue3" 

# Use -Z to Set Positive Wiggle Size, the larger the value, the smaller the size of the positive or negative bulge
# Must be companied by -G option to designate whether it is a positive or negative bulge.
posbulge="-Z0.5"
negbulge="-Z0.5"
...
#awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals |pswiggle $Projection $Region $posbulge -G$pos -Wthin,grey $ADD >> $ps

# Profile A
psbasemap $Projection1 $Region1 -Ba50f10:"Along Main Boundary Thrust":/a2f1:"Time after P arrival (s)":WsNe  $BEG  > $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals1 |pswiggle $Projection1 $Region1 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals1 |pswiggle $Projection1 $Region1 $negbulge -G$neg $ADD >> $ps
# Mark time 0
psxy $Projection1 $Region1 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start1 5
$profile_end1 5
END

# Profile G
psbasemap $Projection7 $Region7 -Ba50f10:"Across Eastern Nepal Himalaya":/a2f1wsNE  $ADD -X13.25 >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals7 |pswiggle $Projection7 $Region7 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals7 |pswiggle $Projection7 $Region7 $negbulge -G$neg $ADD >> $ps
# Mark time 0
psxy $Projection7 $Region7 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start7 5
$profile_end7 5
END

# Profile B
psbasemap $Projection2 $Region2 -Ba50f10:"Along Southern Tibetan Detachment":/a2f1:"Time after P arrival (s)":WsNe  $ADD -X-13.25 -Y5.5  >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals2 |pswiggle $Projection2 $Region2 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals2 |pswiggle $Projection2 $Region2 $negbulge -G$neg $ADD >> $ps
# Mark time 0
psxy $Projection2 $Region2 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start2 5
$profile_end2 5
END
...
# Profile F
psbasemap $Projection6 $Region6 -Ba50f10:"Beneath Nepal Himalaya Transact":/a2f1wsNE  $ADD -X8.5  >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals6 |pswiggle $Projection6 $Region6 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals6 |pswiggle $Projection6 $Region6 $negbulge -G$neg $ADD >> $ps
# Mark time 0
psxy $Projection6 $Region6 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start6 5
$profile_end6 5
END
...
# Profile C
psbasemap $Projection3 $Region3 -Ba50f10:"Along Yarlung Zangbro Suture":/a2f1:"Time after P arrival (s)":WsNe  $ADD -Y5.5 -X-8.5 >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals3 |pswiggle $Projection2 $Region2 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals3 |pswiggle $Projection2 $Region2 $negbulge -G$neg $ADD >> $ps
# Mark time 5
psxy $Projection3 $Region3 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start3 5
$profile_end3 5
END

# Profile D
psbasemap $Projection4 $Region4 -Ba50f10:"                                            Across Western and Central Nepal Himalaya":/a2f1wsNe  $ADD -X8.5 >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals4 |pswiggle $Projection4 $Region4 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals4 |pswiggle $Projection4 $Region4 $negbulge -G$neg $ADD >> $ps
# Mark time 0
psxy $Projection4 $Region4 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start4 5
$profile_end4 5
END
...
# Profile E
psbasemap $Projection5 $Region5 -Ba50f10g20/a2f1wsNE  $ADD -X5.5  >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals5 |pswiggle $Projection5 $Region5 $posbulge -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals5 |pswiggle $Projection5 $Region5 $negbulge -G$neg $ADD >> $ps
# Mark time 0
psxy $Projection5 $Region5 -W1.5,khaki,solid $ADD << END >> $ps
$profile_start5 5
$profile_end5 5
END


# Profile Illustrative Inset
...
## Plot Station or Conversion Points Location
...
awk '{print $6" "$5}' $PIERC | awk '{print $1" "$2}' |psxy $REG_NEP $PROJ $SYM_PIERC $ADD $piercpen >> $ps
...
echo "84.6 27 C N H" | pstext $REG_NEP $PROJ -F+f7p,Helvetica-Bold,gray10+jRB $ADD >> $ps
cat $profileinfo6 | psxy $REG_NEP $PROJ -W1p,khaki1,solid $ADD >> $ps
echo "85.0 26.5 N H T" | pstext $REG_NEP $PROJ -F+f7p,Helvetica-Bold,gray10+jRB $ADD >> $ps
cat $profileinfo7 | psxy $REG_NEP $PROJ -W1p,khaki1,solid $ADD >> $ps
echo "86.5 26.3 E N H" | pstext $REG_NEP $PROJ -F+f7p,Helvetica-Bold,gray10+jRB $ADD >> $ps
...
#awk '{print $1,"1",$2}' $summation | pswiggle $Proj_sum $Region_sum $posbulge -G-gray $ADD >> $ps
# Mark time 0
#psxy $Proj_sum $Region_sum -W1.5,khaki,solid $ADD << END >> $ps
#0 0
#0 2
#END
