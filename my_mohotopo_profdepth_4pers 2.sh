...
psxyz $REG3D $PROJ $PROJZ $PERSP $RAYPEN $ADD $RAY3D -X-18c -Y-13.5c -t25  >> $ps
...
echo "$point1z S3" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z N3" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
point1z=`echo $point1 |grdtrack -G$nepaltopogrd`
point2z=`echo $point2 |grdtrack -G$nepaltopogrd` 
echo "$point1z S4" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z N4" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
point1z=`echo $point1 |grdtrack -G$nepaltopogrd`
point2z=`echo $point2 |grdtrack -G$nepaltopogrd` 
echo "$point1z S2" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z N2" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
point1z=`echo $point1 |grdtrack -G$nepaltopogrd`
point2z=`echo $point2 |grdtrack -G$nepaltopogrd` 
echo "$point1z S1" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z N1" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
point1z=`echo $point1 |grdtrack -G$nepaltopogrd`
point2z=`echo $point2 |grdtrack -G$nepaltopogrd` 
echo "$point1z W1" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z E1" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
point1z=`echo $point1 |grdtrack -G$nepaltopogrd`
point2z=`echo $point2 |grdtrack -G$nepaltopogrd` 
echo "$point1z W2" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z E2" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
point1z=`echo $point1 |grdtrack -G$nepaltopogrd`
point2z=`echo $point2 |grdtrack -G$nepaltopogrd` 
echo "$point1z W3" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
echo "$point2z E3" | pstext $REG3D -J -JZ -p -F+f12,Times-Bold,gray25+jCM -Dj0.1i/0.0i -Z $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $1,$3}' |sed '1d' | psxy -JX12c/-2c -R$startlo/$endlo/34/56 -W1.75p,black,. -Ba0.5f0.1:"Longitude (deg)":/a5f1gSWne -Y21c -X0.5c $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $1,$3}' |sed '1d' | psxy -JX8c/-2c -R$startlo/$endlo/44/66 -W1.75p,black,. -Ba0.5f0.1/a5f1gSWne -Y3c $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $1,$3}' |sed '1d' | psxy -JX8c/-2c -R$startlo/$endlo/58/82 -W1.75p,black,. -Ba0.5f0.1/a5f1gSWne -Y3c $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $2,$3}' |sed '1d' | psxy -JX4.5c/-2c -R$startla/$endla/35/55 -W1.75p,black,. -Ba0.5f0.1/a5f1g1SWne -X12.5c $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $2,$3}' |sed '1d' | psxy -JX3.5c/-2c -R$startla/$endla/35/55 -W1.75p,black,. -Ba0.5f0.1/a5f1g1SwnE -X5c $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $2,$3}' |sed '1d' | psxy -JX10c/-2c -R$startla/$endla/40/80 -W1.75p,black,. -Ba0.5f0.1/a10f2g2SWnE  -Y-3c -X-5c $ADD >> $ps
...
project -C$startlo/$startla -E$endlo/$endla -G2/90 -Q |awk 'BEGIN{print "> NHT_GreatCycle"};{print $1,$2}' | grdtrack -G$mohotopogrd | awk '{print $2,$3}' |sed '1d' | psxy -JX8.5c/-2c -R$startla/$endla/40/80 -W1.75p,black,. -Ba0.5f0.1:"Latitude (deg)":/a10f2g2SwnE -Y-3c $ADD >> $ps
