...
#awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals |pswiggle $Projection $Region -Z0.5 -G$pos -Wthin,grey $ADD >> $ps

# Profile A
psbasemap $Projection1 $Region1 -Ba0.5f0.1g0.2:"RFs Along Main Boundary Thrust":/a2f1g1:"Time after P arrival (s)":WsNe  $BEG  > $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals1 |pswiggle $Projection1 $Region1 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals1 |pswiggle $Projection1 $Region1 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 0
psxy $Projection1 $Region1 -W1,grey35,. $ADD << END >> $ps
$profile_start1 5
$profile_end1 5
END

# Profile G
psbasemap $Projection7 $Region7 -Ba0.5f0.1g0.2:"RFs Across Easter Nepal Himalaya":/a2f1g1wsNE  $ADD -X13.25 >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals7 |pswiggle $Projection7 $Region7 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals7 |pswiggle $Projection7 $Region7 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 0
psxy $Projection7 $Region7 -W1,grey35,. $ADD << END >> $ps
$profile_start7 5
$profile_end7 5
END
...
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals2 |pswiggle $Projection2 $Region2 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals2 |pswiggle $Projection2 $Region2 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 0
psxy $Projection2 $Region2 -W1,grey35,. $ADD << END >> $ps
$profile_start2 5
$profile_end2 5
END
...
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals6 |pswiggle $Projection6 $Region6 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals6 |pswiggle $Projection6 $Region6 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 0
psxy $Projection6 $Region6 -W1,grey35,. $ADD << END >> $ps
$profile_start6 5
$profile_end6 5
END
...
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals3 |pswiggle $Projection2 $Region2 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals3 |pswiggle $Projection2 $Region2 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 5
psxy $Projection3 $Region3 -W1,grey35,. $ADD << END >> $ps
$profile_start3 5
$profile_end3 5
END
...
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals4 |pswiggle $Projection4 $Region4 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals4 |pswiggle $Projection4 $Region4 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 0
psxy $Projection4 $Region4 -W1,grey35,. $ADD << END >> $ps
$profile_start4 5
$profile_end4 5
END
...
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals5 |pswiggle $Projection5 $Region5 -Z0.5 -G$pos  $ADD >> $ps
awk '{if($0!~/^>/)print $2,$1,$3;else print $0}' $individuals5 |pswiggle $Projection5 $Region5 -Z0.8 -G-$neg $ADD >> $ps
# Mark time 0
psxy $Projection5 $Region5 -W1,grey35,. $ADD << END >> $ps
$profile_start5 5
$profile_end5 5
END
...
#awk '{print $1,"1",$2}' $summation | pswiggle $Proj_sum $Region_sum -Z0.5 -G-gray $ADD >> $ps
# Mark time 0
#psxy $Proj_sum $Region_sum -W1,grey35,. $ADD << END >> $ps
#0 0
#0 2
#END
