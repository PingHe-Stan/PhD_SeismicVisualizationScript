...
gmtset FONT_ANNOT_PRIMARY=6p,Helvetica,black FONT_LABEL=8p,Helvetica,black
...
grdview ${mohotopogrd} $REG3D $PROJ $PROJZ -Cmygrd.cpt -Imoho.grad -Qs+m -p -t25 $ADD >> $ps
...
grdview ${nepaltopogrd} $REG3D $PROJ $PROJZ $CPTOPT1 -Qs+m $PERSP -I${tectoinfodir}/China.grad -Ba2f1g1/a1f0.5g0.5/a20000f5000g10000:"Topography (m)":SEwnZ $ADD >> $ps
