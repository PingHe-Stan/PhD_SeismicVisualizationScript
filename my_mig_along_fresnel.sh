...
if [ $x_axis1 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection1 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
...
if [ $x_axis2 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection2 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
psxy -R -J -W1.3,grey75,. -K -O << END >> $ps
$startlo 45
$endlo 45
END
...
if [ $x_axis3 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection3 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
psxy -R -J -W1.3,grey75,. -K -O << END >> $ps
$startlo 60
$endlo 60
END
...
if [ $x_axis4 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection4 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
psxy -R -J -W1.3,grey75,. -K -O << END >> $ps
$startlo 30
$endlo 30
END
...
if [ $x_axis5 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection5 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
psxy -R -J -W1.3,grey75,. -K -O << END >> $ps
$startlo 30
$endlo 30
END
...
if [ $x_axis6 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection6 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
psxy -R -J -W1.3,grey75,. -K -O << END >> $ps
$startlo 50
$endlo 50
END
...
if [ $x_axis7 = "lon" ]
	then
	psbasemap -R$startlo/$endlo/0/158 $Projection7 -Ba0.5f0.25:"Longitude (@+o@+E)":/a20f10:"Depth (km)":WSen -K -O < /dev/null >> $ps
psxy -R -J -W1.3,grey75,. -K -O << END >> $ps
$startlo 40
$endlo 40
END
