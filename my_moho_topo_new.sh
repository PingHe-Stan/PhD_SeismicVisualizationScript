...
psscale -D12c/6c/3c/0.3c -I -E -Ba20f10:"Depth (km)": -Ctmp.cpt -K -O >> $ps
...
grdview ${mohotopogrd} $REG3D $PROJ $PROJZ -Cmygrd.cpt -Imoho.grad -Qs+m -Ba2f1g1/a1f0.5g0.5/a20000f5000g10000:"Topography (m)":SEwnZ -p $ADD >> $ps
...
psxyz $REG3D $PROJ $PROJZ $PERSP $RAYPEN $ADD $RAY3D -t60  >> $ps
